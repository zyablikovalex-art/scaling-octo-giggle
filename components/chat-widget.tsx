    ...
    >
      ...
      >
        <input
          ...
          className="flex-1 rounded-md border border-input bg-background px-3 py-2 text-base outline-none transition-colors focus:border-ring focus:ring-2 focus:ring-ring/40 disabled:opacity-60 sm:text-sm"
        />
        <Button
          type="submit"
          size="icon"
